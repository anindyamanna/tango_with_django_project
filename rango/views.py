...
def index(request):
    ...
    context_dict['categories_views'] = category_list_views
...
#def homepage(request):
 #   return render_to_response('rango\index.html',{'boldmessage':"Hello bold!"})
...
def add_page(request, category_name_url):
    ...
    context_dict = {'form': form, 'category_name_url': category_name_url, 'category_name': cat}
